...
st.title("SYOVY Helath Care Center")
st.subheader("Select Symptoms what you are suffering from the list below:")
...
if symptoms_input:
    ...
    disease = get_predicted_value(symptoms_input)
    st.write(f"The predicted disease is: {disease}")

    st.subheader("Information on the Disease:")
    ...
    st.write("Please select symptoms to proceed.")
